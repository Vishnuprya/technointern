...
class Calci implements ActionListener{
    ...
    JButton btnPlus,btnMinus,btnDiv,btnMul,
    btnRem,btnZero,btn2Zero,btnEq,btnDec,btnAC,btnDel;
    ...
    public Calci(){
        ...
        btnMul=new JButton("*");
        btnMul.setFont(ff2);
        btnMul.setBackground(new Color(40,40,40));
        btnMul.setForeground(Color.GREEN);
